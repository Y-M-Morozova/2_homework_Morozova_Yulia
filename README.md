...
7.  А теперь я останаувливаю и удаляю контейнер с сервером(беру его id),создаю его заново и подключаюсь снова из контейнера с клиентом к контейнеру с сервером:

    ![7aa](https://github.com/Y-M-Morozova/2_homework_Morozova_Yulia/assets/153178571/baff1194-41d4-4b77-a0ac-4bc1c37e7cd5)

    <br/><br/>

8.  Проверяю свою тестовую БД test_db, а в ней тестовую табличку test, и две вставленные строки, все на месте:
